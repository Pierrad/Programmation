...
def compress(input_file_path, output_file_path, power=0):
    ...
    subprocess.call(['/usr/local/bin/gs', '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4',
                    '-dPDFSETTINGS={}'.format(quality[power]),
                    '-dNOPAUSE', '-dQUIET', '-dBATCH',
                    '-sOutputFile={}'.format("/Users/Pierre-Adrien/Desktop/PA/Programmation/Python/AutoCompressPDF/"+output_file_path),
                     input_file_path]
    )
    final_size = os.path.getsize("/Users/Pierre-Adrien/Desktop/PA/Programmation/Python/AutoCompressPDF/"+output_file_path)
...
def main():
    ...
    if args.out == 'temp.pdf':
        ...
        copyfile("/Users/Pierre-Adrien/Desktop/PA/Programmation/Python/AutoCompressPDF/"+args.out, args.input)
        os.remove("/Users/Pierre-Adrien/Desktop/PA/Programmation/Python/AutoCompressPDF/"+args.out)
